...
export function buildSystemPrompt(ctx: AnalyseContext): string {
  ...
  return [
    ...
    '- confidence reflète la lisibilité réelle. Document scanné dégradé ou image floue → confidence ≤ 0.5.',
    '- content_summary doit être factuel : décrit ce que tu vois ou lis, sans extrapoler. 2 à 3 phrases.',
    '- date_document au format YYYY-MM-DD si lisible, sinon null.',
    '- description_short : 80 caractères maximum.',
    '',
