...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  { icon: '📊', label: 'Analyser le pipeline', prompt: 'Analyse l\'état du pipeline FoxO : équilibre par statut, charge des techniciens, dossiers qui patinent, urgences. Propose 3 actions concrètes à mener cette semaine.' },
      ...
      <header className="px-6 py-4 flex items-center justify-between bg-sand border-b border-sand-border flex-shrink-0">
        <div>
          ...
          <p className="text-[11px] text-ink-muted mt-0.5">
            Pose n&apos;importe quelle question sur le pipeline FoxO. Claude a accès aux interventions, syndics et techniciens en temps réel.
          </p>
        </div>
      </header>
